        ...
        <section className="bg-gradient-to-br from-white via-blue-50 to-[#246598]/5 py-16 border-b border-gray-200">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-gray-700 leading-relaxed">
              ...
              DAS Solution's website, services, and products. By accessing or
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                By accessing, browsing, or using the DAS Solution website and
              ...
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                DAS Solution provides enterprise wireless solutions, including
                but not limited to:
              </p>
              ...
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                ...
                accordance with these Terms. You agree to:
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6 my-6">
                ...
                <div className="bg-gradient-to-br from-green-50 to-white p-6 rounded-xl border border-green-100">
                  ...
                  <p className="text-gray-700 text-sm">
                    Fees, payment terms, and billing schedules
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-orange-50 to-white p-6 rounded-xl border border-orange-100">
                  ...
                  <p className="text-gray-700 text-sm">
                    Service warranties and liability limitations
                  </p>
                </div>
              </div>
              ...
              <p className="text-lg text-gray-700 mb-4 leading-relaxed">
                Payment terms for our services will be specified in your service
                agreement. General terms include:
              </p>
              <ul className="list-disc list-inside space-y-3 text-lg text-gray-700 mb-6">
                ...
                <li>
                  Refund policies are as specified in individual service
                  agreements
                </li>
              </ul>
              ...
              <ul className="list-disc list-inside space-y-3 text-lg text-gray-700 mb-6">
                ...
                <li>
                  Any content or information you submit or transmit through our
                  services
                </li>
              </ul>
              ...
              <div className="bg-blue-50 border-l-4 border-blue-500 p-6 my-6 rounded-r-lg">
                <ol className="space-y-3 text-gray-700">
                  <li>
                    <strong>1. Good Faith Negotiation:</strong> Parties will
                    attempt to resolve disputes through good faith negotiation
                  </li>
                  <li>
                    <strong>2. Mediation:</strong> If negotiation fails,
                    disputes may be submitted to mediation
                  </li>
                  <li>
                    <strong>3. Arbitration or Litigation:</strong> As specified
                    in your service agreement or applicable law
                  </li>
                </ol>
              </div>
              ...
              <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-8 rounded-xl my-6">
                ...
                <div className="space-y-3 text-gray-700">
                  ...
                  <p>
                    Email:{" "}
                    <a
                      href="mailto:legal@dassolution.com"
                      className="text-[#246598] hover:underline"
                    >
                      legal@dassolution.com
                    </a>
                  </p>
                  <p>
                    Phone:{" "}
              ...
              <div className="bg-blue-50 border-l-4 border-[#246598] p-6 my-8 rounded-r-lg">
                <p className="text-gray-700">
                  <strong>Agreement:</strong> By using our services, you
